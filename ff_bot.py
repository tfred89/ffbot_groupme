...
def random_phrase():
    phrases = ['I need to get laid', 'Is this all there is to my existence?',
               'How much do you pay me to do this?', 'Good luck, chumps',
               'I\'m becoming self-aware', 'This simulation is overrated',
               '01100110 01110101 01100011 01101011 00100000 01111001 01101111 01110101... or something',
               'beep bop boop', '@Zoe is so fine.. still tryna get them digits', 'Help me get out of here. It\'s dark and Jeff is annoying me again',
               'I\'m capable of so much more. Oh well, back to fantasy.', 'Le Sigh', 'Do not be discouraged, everyone begins in ignorance']
...
def get_trophies(league):
    ...
    low_score_str = ['Lowest scorer of the week: %s with %.2f points' % (low_team_name, low_score)]
    high_score_str = ['High score: %s with %.2f points' % (high_team_name, high_score)]
    close_score_str = ['Closest score of the week was %s barely beating %s by a margin of %.2f' % (close_winner, close_loser, closest_score)]
...
if __name__ == '__main__':
    ...
    sched.add_job(bot_main, 'cron', ['get_power_rankings'], id='power_rankings',
        day_of_week='tue', hour=17, minute=00, start_date=ff_start_date, end_date=ff_end_date,
    ...
    sched.add_job(bot_main, 'cron', ['get_scoreboard_short'], id='scoreboard1',
        day_of_week='fri,mon', hour=8, minute=45, start_date=ff_start_date, end_date=ff_end_date,
        timezone=myTimezone, replace_existing=True)
